...
class main {
  ...
  get = function (lang, line) {
    ...
    if (typeof translation === 'string') { return translation.replace('APPNAME', this.app.name).replace('FOOTER', this.app.config.system.footerText); } else { return translation; }
  };
}
