...
module.exports = {
  ...
  execute: async (app) => {
    ...
    try {
      ...
      try {
        if (registeringToAll) { await app.client.application.commands.set(app.client.arrayOfSlashCommands); } else { await app.client.guilds.cache.get(app.config.commands.registerToServer).commands.set(app.client.arrayOfSlashCommands); }
